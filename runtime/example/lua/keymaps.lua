...
map("prefix", "<leader>:", "command_prompt", { desc = "Command prompt" })
map("prefix", "<leader>s", "choose_tree_session", { desc = "Tree view (sessions collapsed)" })
map("prefix", "<leader>w", "choose_tree_window", { desc = "Tree view (windows collapsed)" })
...
map("prefix", "<leader>*", "toggle_sync_panes", { desc = "Toggle synchronize panes" })
